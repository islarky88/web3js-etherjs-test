...
/**
* WHAT IS AceSecurityToken?   
 * AceSecurityToken is for general ethereum NFT token use; NFT Block Chain Token, URL link, Ethereum Interface,
 ...
 * @dev see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md
 */
contract AceSecurityToken is SupportsInterfaceWithLookup, ERC721, ERC721BasicToken, Ownable {
    ...
    // Token name
    string public name_ = "AceSecurityToken";
